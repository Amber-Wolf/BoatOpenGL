...
public:
	...
	wolfercmLab7()
	{
		...
		floor = new Floor(this, 200.0f);
		childSphere = new Sphere(this, 0.5f,20, vec4(0.0f,229.0f,238.0f,0.0f));
		//childSphere->addController(new WayPointController(1.0f,vec3(1.0f,0.0f,0.0f),vec3(0.0,-1.5f,0.0)));
		childSphere->fixedTransformation = translate(mat4(1.0f),vec3(0.0f,0.0f,1.0f));
		pyramid4->addChild(childSphere);
		rotationX = 0.0f;
		rotationY = 0.0f;
		viewTranslate = -12.0f;
	};
	...
	VisualObject * pyramid0, * pyramid1, *pyramid2, *pyramid3, *pyramid4, *childSphere;
